 ...
 *
 * Copyright 2014,
Steven Wanderski - http://stevenwanderski.com - http://bxcreative.com
...
!function(t){
	...
	s={
		...
		i){
			...
			void 0;var n=0;e.find("img, iframe").each(function(){
				t(this).one("load",
				function(){
					++n==s&&i()
				}).each(function(){
		...
		v=function(){
			...
			s=t();if("vertical"==o.settings.mode||o.settings.adaptiveHeight)if(o.carousel){
				...
				i=1;i<=o.settings.maxSlides-1;i++)s=n+i>=o.children.length?s.add(o.children.eq(i-1)):s.add(o.children.eq(n+i))
		...
		x=function(){
			var t=0;if(o.settings.moveSlides>0)if(o.settings.infiniteLoop)t=o.children.length/m();else for(var e=0,
		...
		H=function(){
			o.settings.autoDelay>0?setTimeout(r.startAuto,
		...
		i){
			...
			o.settings.controls&&W(),
			"fade"==o.settings.mode)o.settings.adaptiveHeight&&o.viewport.height()!=v()&&o.viewport.animate({
				height:v()
			},
